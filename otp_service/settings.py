...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("POSTGRES_USER", "finmitra_admin"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "finmitra@2025"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "FinMate Watson Chat API",
    "DESCRIPTION": "Watson-backed chat endpoints",
    "VERSION": "1.0.0",
}
...
# Support both TWILIO_PHONE_NUMBER and DEFAULT_FROM_PHONE_NUMBER for backward compatibility
TWILIO_PHONE_NUMBER = os.getenv("TWILIO_PHONE_NUMBER", "") or DEFAULT_FROM_PHONE_NUMBER
